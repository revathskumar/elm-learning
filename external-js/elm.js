...
Elm.Main.make = function (_elm) {
   ...
   _U.list([A2($Html.div,_U.list([$Html$Attributes.$class("welcome")]),_U.list([$Html.text("Hello World!!")]))
           ,A2($Html.div,_U.list([]),_U.list([$Html.text("Another Message with external js")]))]));
