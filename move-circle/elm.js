...
Elm.Main.make = function (_elm) {
   ...
   var inputSignal = function () {
      var dt = $Time.fps(30);
      var tuples = A3($Signal.map2,F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),dt,$Keyboard.arrows);
      return A2($Signal.sampleOn,dt,tuples);
   }();
   ...
   var update = F2(function (_p0,ball) {
      var _p1 = _p0;
      var newVel = $Basics.toFloat(_p1._1.x);
      return A2(updateVelocity,newVel,A2(applyPhysics,_p1._0,ball));
   });
   var initBall = {position: 0,velocity: 0};
   var main = A2($Signal.map,$Graphics$Element.show,A3($Signal.foldp,update,initBall,inputSignal));
