...
Elm.Main.make = function (_elm) {
   ...
   var keys = {x: -1,y: 1};
   var dt = 100;
   var view = F2(function (_p0,ball) {
      var _p1 = _p0;
      return A3($Graphics$Collage.collage,
      _p1._0,
      _p1._1,
      _U.list([A2($Graphics$Collage.move,
      {ctor: "_Tuple2",_0: ball.position,_1: 0},
      A2($Graphics$Collage.filled,A3($Color.rgb,0,0,0),$Graphics$Collage.circle(20)))]));
   });
   var inputSignal = A3($Signal.map2,F2(function (v0,v1) {    return {ctor: "_Tuple2",_0: v0,_1: v1};}),$Time.fps(30),$Keyboard.arrows);
   var Keys = F2(function (a,b) {    return {x: a,y: b};});
   var updateVelocity = F2(function (newVelocity,ball) {    return _U.update(ball,{velocity: newVelocity});});
   var applyPhysics = F2(function (dt,ball) {    return _U.update(ball,{position: ball.position + ball.velocity * dt});});
   var update = F2(function (_p2,ball) {
      var _p3 = _p2;
      var newVel = $Basics.toFloat(_p3._1.x);
      return A2(updateVelocity,newVel,A2(applyPhysics,_p3._0,ball));
   });
   var initBall = {position: 0,velocity: 0};
   var main = A3($Signal.map2,view,$Window.dimensions,A3($Signal.foldp,update,initBall,inputSignal));
   var Ball = F2(function (a,b) {    return {position: a,velocity: b};});
